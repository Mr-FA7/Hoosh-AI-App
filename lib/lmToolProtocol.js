...
const KERNEL_TOOLS = [
  ...
  {
    name: 'stackUp',
    description: 'Start Hoosh Stack services from compose.yaml / docker-compose.yml (Docker or Podman)',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'stackDown',
    description: 'Stop Hoosh Stack compose services',
    inputSchema: {
      type: 'object',
      properties: {
        composeFile: { type: 'string' },
  ...
  {
    name: 'stackStatus',
    description: 'List compose services and container runtime status for the project',
    inputSchema: {
      type: 'object',
      properties: { composeFile: { type: 'string' } }
    }
  },
  {
    name: 'stackLogs',
    description: 'Fetch compose service logs (tail)',
    inputSchema: {
      type: 'object',
      properties: {
        composeFile: { type: 'string' },
